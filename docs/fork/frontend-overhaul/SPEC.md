...
| A5 | Close dialog parity | The dialog offers 5 reasons including audit-no-change. Two evidence rows can be added, and after completion both appear in `kata show <ref> --json` close event evidence. |
