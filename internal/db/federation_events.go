...
// ValidateFederationCommentTeammates rejects malformed optional teammate
// attribution before a federation event can update a durable projection.
func ValidateFederationCommentTeammates(eventType, eventUID string, payloadJSON json.RawMessage) error {
